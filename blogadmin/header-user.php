...
<html lang="en">
  ...
  <!-- Sidebar -->
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Administration du Blog MMEC</a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="blogs_view.php"><i class="fa fa-rss"></i> Articles</a></li>
            <li><a href="blogs_view.php"><i class="fa fa-check"></i>Articles Publiés</a></li>
            <?php
         ...
         <ul class="nav navbar-nav navbar-right navbar-user">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo PREPEND_PATH; ?>membership_profile.php"><i class="fa fa-user"></i> <strong>Profile</strong> </a></li>
 ...
 <div class="row">
          <div class="col-lg-12">
            <h1>Bienvenue <?php echo getLoggedMemberID(); ?> ! 👋 </h1>
            <ol class="breadcrumb">
              <li><a href="../blog.php"><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Voir le blog</strong></a></li>
              <li><a href="index.php"><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Voir L'administration du blog</strong></a></li>
              <li><a href="../ajoutactiviter.php"><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Ajouter une activité</strong></a></li>
              <li><a href="../index.php"><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Retourner a l'Accueil</strong></a></li>
