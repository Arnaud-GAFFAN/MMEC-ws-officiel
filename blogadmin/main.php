              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Rédiger</strong></p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Publiés</strong></p>
                  </div>
                </div>
              </div>
              <a href="blogs_view.php">
...
<footer class="footer footer-inverse">
      <div class="container">
        <div class="text-center">
          <small>Administration du Blog</a></small>
        </div>
      </div>
    </footer>
  </body>
