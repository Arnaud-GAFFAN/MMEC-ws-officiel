...
function blogs_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if($selected_id){
		...
		$combo_posted->SelectedText = ( $_REQUEST['FilterField'][1]=='9' && $_REQUEST['FilterOperator'][1]=='<=>' ? ($_REQUEST['FilterValue'][1]) : "");
	}
	...
	<script>
		...
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			$j("#category-container__RAND__").select2({
				...
				width: '100%',
				formatNoMatches: function(term){ return '<?php echo addslashes($Translation['Aucun enrégistrement']); ?>'; },
